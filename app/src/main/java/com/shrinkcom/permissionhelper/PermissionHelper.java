package com.shrinkcom.permissionhelper;
...
public class PermissionHelper {
   /* static final String RECORD_VIDEO = "android.permission.RECORD_VIDEO";
...
*/
  /*  public static void requestRecordVideo(final OnPermissionGrantedListener listener) {
        request(listener, RECORD_VIDEO);
    }


    public static void requestOutgoingCalls(final OnPermissionGrantedListener listener) {
        request(listener, PROCESS_OUTGOING_CALLS);
    }

    public static void requestReadPhoneState(final OnPermissionGrantedListener listener) {
        request(listener, READ_PHONE_STATE);
    }*/
