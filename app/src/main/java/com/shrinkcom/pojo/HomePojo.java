...
public class HomePojo {
    ...
    private String icon_normal, icon_active,icon_car,is_pool_type,has_pool_option;
    ...
    public void setCar_icon(String cat_name) {
        this.icon_car = cat_name;
    }
    ...
    public void setPoolType(String cat_id) {
        this.is_pool_type = cat_id;
    }

    public String getPoolOption() {
        return has_pool_option;
    }

    public void setPoolOption(String driver_lat) {
        this.has_pool_option = driver_lat;
    }
