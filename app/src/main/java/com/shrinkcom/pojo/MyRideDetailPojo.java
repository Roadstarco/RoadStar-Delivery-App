...
public class MyRideDetailPojo {
    ...
    private String currrencySymbol, rideId, displayStatus, doCancelAction, pay_status, LocationLat, LocationLong,payDispStatus,Dropaddress;
    private String doTrackAction, isFavLocation;
    private String distanceUnit;
    private String doFavLocation,location_key;
    ...
    public String getPayDisplayStatus() {
        return payDispStatus;
    }

    public void setPayDisplayStatus(String displayStatus) {
        this.payDispStatus = displayStatus;
    }
    ...
    public void setRideDisplayStatus(String displayStatus) {
    ...
    public void setDoFavLocation(String doFavLocation) {
        this.doFavLocation = doFavLocation;
    }

    public String getDoFavLocation() {
        return doFavLocation;
    }
